            ...
            <div class="col-md-5 mt-5">
              ...
              <div class="box-title-event m-auto text-left">
                <h1 class="text-gray lh-1-0 p-b-25">
                  <b>Event Coffee Royal community</b>
                </h1>
                  ...
                  <div class="position-relative overlay-wrapper">
                    <div class="mitra-card bg-white br-10">
                      ...
                      <div class="pt-2">
                        <div class="d-flex align-items-center">
                          <div class="text-center bg-darkcream py-2 px-3 br-5 mr-2">
                            <p
                              class="fs-14 m-0"
                            >{{ $moment(l.content.date.start_date ).format('D') }}</p>
                            <p
                              class="text-red-portal fs-11 mb-0 uppercases"
                            >{{ $moment(l.content.date.start_date ).format('MMM') }}</p>
                            <p
                              class="text-red-portal fs-11 mb-0 uppercases"
                            >{{ $moment(l.content.date.start_date ).format('Y') }}</p>
                          </div>
                          <div>
                            <!-- <img src="/assets/themes/lightred/images/star.svg" width="17" alt />
                            <img src="/assets/themes/lightred/images/star.svg" width="17" alt />
                            <img src="/assets/themes/lightred/images/star.svg" width="17" alt />
                            <img src="/assets/themes/lightred/images/star.svg" width="17" alt />
                            <img src="/assets/themes/lightred/images/star.svg" width="17" alt />-->
                            <div class="mt-2">
                              <p class="m-0 fs-10">{{ l.content.location.name }}</p>
                              <p
                                class="m-0 fs-10"
                              >{{ l.content.date.start_time }} - {{ l.content.date.end_time }}</p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="mitra-card-overlay position-absolute br-10">
                      <div class="py-5 px-3">
                        ...
                        <div class="pt-1 fs-13 mb-4">{{ l.title }}</div>
                        <nuxt-link
                          :to="{ path: `/event/${l.id}/${l.slug}`}"
                          class="btn btn-lg btn-block btn-outline-danger py-1 fs-12"
                        >Detail</nuxt-link>
