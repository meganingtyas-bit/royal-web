            ...
            <div class="col-lg-6 col-md-8">
              ...
              <div class="box-title-event m-auto text-left">
                <h1 class="text-gray-portal lh-1-0 p-b-25">
                  <b>Artikel Coffee Royal community</b>
                </h1>
                <div class="box-content-event m-auto text-gray-portal lh-1-8 p-b-45">
                  <p>Jika ingin mengetahui artikel lainnya seputar Coffee Royal community bisa dilihat didalam list yang ada pada direktori dibawah ini</p>
                </div>
              </div>
            </div>
          </b-row>
                  ...
                  <b-input-group>
                    ...
                    <template v-slot:append>
                      ...
                      <b-button
                        ...
                        @click="querys"
                      >
                        <!-- <img src="/assets/themes/lightred/images/search.svg" class="mr-1" /> -->
                ...
                >
                  <div class="box-news">
                    <div class="box-img-event p-0">
                      <nuxt-link :to="{ path: `/article/${l.id}/${l.slug}`}">
                    ...
                    <div class="box-title-news p-1">
                      <div class="row">
                        <div class="col-md-12">
                          <nuxt-link :to="{ path: `/article/${l.id}/${l.slug}` }">
                            <span class="text-muted dots-text font-weight-bold fs-14">{{ l.title }}</span>
                          </nuxt-link>
                        </div>
                        <!-- <div class="col-md-4">
              ...
              <div class="ctm-pagination d-flex justify-content-center">
                ...
                >
                  ...
                  <li v-if="datas.pagination.next > 0" class="page-item">
                    <a
                      href="javascript:;"
                      @click="pagenums(datas.categorypagination.current+1)"
                      class="page-link"
                    >Selanjutnya</a>
                  </li>
