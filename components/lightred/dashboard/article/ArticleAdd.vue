    ...
    <div class="dashboard-content">
  		<b-container>
  			<div class="d-flex detail-loc fs-12 text-red mb-3">
  				...
  				>>
  				<nuxt-link to="/dashboard/article" class="text-default mx-1">Artikel</nuxt-link>
  				>>
  				<nuxt-link to="#" class="text-default mx-1">Buat Artikel</nuxt-link>
  			</div>
  			<div class="d-flex align-items-center">
  				<img src="/assets/themes/lightred/images/subtitle_red.png" class="mr-2" alt="">
  				<h4 class="dashboard-title m-0">Buat Artikel</h4>
  			</div>
    ...
    methods: {
      ...
      validation () {
        ...
        if (form.image.length < 1) {
          error.image = 'Poster artikel tidak boleh kosong'
          valid = false
        } else {
          error.image = ''
          valid = true
