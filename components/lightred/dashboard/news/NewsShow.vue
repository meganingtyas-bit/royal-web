      ...
      <div class="container">
        <div class="row align-items-end pb-3">
          <div class="col-lg-12">
            ...
            <div class="box-title fs-18 text-muted pb-4">
              <span>
                <img src="/assets/themes/lightred/images/subtitle_red.png" alt />Berita Saya
              </span>
            </div>
            <div class="row">
              <div class="col-lg-12">
                <div class="row">
                  <div class="col-md-3">
                    ...
                    >
                      <i class="fa fa-pencil mr-2"></i>TAMBAH BERITA
                    </nuxt-link>
                  </div>
                  <div class="col-md-9">
        ...
        <div v-if="loadedData">
          <div class="row py-3" v-if="posts.length > 0">
            <div class="col-lg-6 py-3 px-2 px-lg-3" v-for="(post, index) in posts" :key="index">
                ...
                <b-media>
                  ...
                  <div class="mb-1">
                    ...
                    <div class="btn-aksi text-right">
                      <nuxt-link
                        :to="{ path: `news/edit?id=${post.id}&slug=${post.slug}`}"
                        class="text-muted"
                        v-b-tooltip.hover
                        title="Ubah"
                      >
          ...
          <div class="row justify-content-center p-t-110" v-else>
            <div class="box-default m-auto text-center">
              ...
              />
              <h3 class="op-0-4 mt-2">"Tidak Ada Berita"</h3>
            </div>
          </div>
