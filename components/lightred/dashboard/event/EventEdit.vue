    ...
    <div class="dashboard-content">
  		<b-container>
  			<div class="d-flex detail-loc fs-12 text-red mb-3">
  				...
  				>>
  				<nuxt-link to="#" class="text-default mx-1">Ubah Event</nuxt-link>
  			</div>
  			<div class="d-flex align-items-center">
  				<img src="/assets/themes/lightred/images/subtitle_red.png" class="mr-2" alt="">
  				<h4 class="dashboard-title m-0">Ubah Event</h4>
  			</div>
    ...
    methods: {
      async fetchDetail () {
        ...
        .then(response => {
          ...
          this.price = response.result.content.event_ticket_price
          this.image = {
            title: 'Seret Atau Taruh File Gambar Disini Atau Klik',
