        ...
        <div class="row align-items-start">
          <div class="col-lg-12">
            ...
            <div class="box-title fs-18 text-muted pb-4">
              <span>
                <img src="/assets/themes/lightred/images/subtitle_red.png" alt />Forum Saya
              </span>
            </div>
            <div class="col-lg-12">
              <div class="row">
                <div class="col-md-3">
                  <nuxt-link
                    ...
                    class="btn btn-dashboard btn-danger-lightred fs-12 ml-0"
                  >
                    <i class="fa fa-pencil mr-2"></i>TAMBAH FORUM
                  </nuxt-link>
                </div>
                <div class="col-md-9">
                  <div class="search-wrap list-dash-filter">
                    <div class="input-group ctm-input-group">
                      <b-form-input class="col-md-10" placeholder="Masukkan Kata Kunci Usaha"></b-form-input>
                      <!-- <input type="text" class="form-control" placeholder="Tanggal Posting" onfocus="(this.type='date')"/> -->
                      <select class="form-control" style="min-height: 38px;">
                        <option>Status</option>
                      </select>
                      <button class="btn btn-sm-dashboard btn-danger-lightred brd-top-0">
        ...
        <div v-if="loadedData">
          ...
          <div class="row justify-content-center p-t-110" v-else>
            <div class="box-default m-auto text-center">
              ...
              />
              <h3 class="op-0-4 mt-2">"Tidak Ada Forum"</h3>
            </div>
          </div>
